...
def minimap2_align(mm2_prog_path, fa_file, fq_in, bam_out, no_flank=False, bed12_junc=None, seed=None):
    """
...
def minimap2_tr_align(mm2_prog_path, fa_file, fq_in, bam_out, seed=None):
    """
